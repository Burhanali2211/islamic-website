  ...
  return (
    ...
    >
      ...
      <section className="relative h-[90vh] min-h-[700px] flex items-center justify-center text-white overflow-hidden">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-b from-green-950/50 via-green-950/70 to-green-950/90"></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          >
            ...
            <motion.h1
              className="text-3xl sm:text-5xl lg:text-7xl font-bold mb-4 tracking-tight leading-tight"
            ...
            <motion.h2
              className="text-xl sm:text-2xl lg:text-4xl font-medium mb-6 text-gold leading-relaxed"
            ...
            <motion.p
              className="text-base sm:text-lg lg:text-xl mb-10 text-gray-100 max-w-4xl mx-auto leading-relaxed"
          ...
          >
            <Link to="/library">
              <button className="px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-white bg-gradient-to-r from-green-500 to-green-600 hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-green-500/25 flex items-center space-x-2 border border-green-400/30 backdrop-blur-sm">
            ...
            <Link to="/about">
              <button className="px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-white border-2 border-gold/50 hover:bg-gold/10 hover:scale-105 transition-all duration-300 backdrop-blur-sm flex items-center space-x-2">
      ...
      <section className="container mx-auto px-4 sm:px-6 -mt-32 sm:-mt-48 relative z-20">
      ...
      <section className="container mx-auto px-6">
        ...
        >
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/library" className="text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-medium flex items-center space-x-1">
