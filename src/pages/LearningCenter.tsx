...
export function LearningCenter() {
  ...
  const testimonials = [
    ...
    { name: 'Fatima Zahra', quote: 'Alhamdulillah, the courses offered here have deepened my connection with Islamic knowledge and helped me grow spiritually.', image: 'https://i.pravatar.cc/150?u=researcher1' },
  ];
