...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        'sans': ['Lexend', 'Amiri', 'Noto Sans Arabic', 'sans-serif'],
      ...
      boxShadow: {
        ...
        'islamic': '0 10px 25px -5px rgba(34, 197, 94, 0.1), 0 10px 10px -5px rgba(34, 197, 94, 0.04)',
        'neomorph': '20px 20px 60px #bebebe, -20px -20px 60px #ffffff',
        'neomorph-inset': 'inset 20px 20px 60px #bebebe, inset -20px -20px 60px #ffffff',
      },
      screens: {
        'xs': '475px',
        '3xl': '1600px',
